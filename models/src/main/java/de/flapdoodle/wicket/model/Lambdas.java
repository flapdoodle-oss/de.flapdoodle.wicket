...
public class Lambdas {
	 ...
	 * @param setter a consumer that sets a {@code <T>}
	 ...
	 * </pre>
	 *
	 * @param setter the setter function (also known as consumer)
	 * @return a write-only model
	 * @throws UnsupportedOperationException when {@link IModel#getObject()} is called
	 */
